...
Devise.setup do |config|
  ...
  # determining whether or not authentication should be aborted when
  ...
  # your model lookup. For instance, if you set :request_keys
  ...
  # environments. Note that, for bcrypt (the default encryptor), the cost
  # increases exponentially with the number of stretches (e.g. a value of
  # 20 is already extremely slow: approx. 60 seconds for 1 calculation).
  ...
  # tools as :clearance_sha1, :authlogic_sha512 (then you should set
  # stretches above to 20 for default behavior) and
